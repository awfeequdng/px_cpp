...
inline void writeHexByteLowercase(uint8_t byte, void * out)
{
...
inline void writeBinByte(uint8_t byte, void * out)
{
...
inline uint8_t unhex2(const char * data)
{
    return
          static_cast<uint8_t>(unhex(data[0])) * 0x10
        + static_cast<uint8_t>(unhex(data[1]));
}

inline uint16_t unhex4(const char * data)
{
    return
          static_cast<uint16_t>(unhex(data[0])) * 0x1000
        + static_cast<uint16_t>(unhex(data[1])) * 0x100
        + static_cast<uint16_t>(unhex(data[2])) * 0x10
        + static_cast<uint16_t>(unhex(data[3]));
}
